...
public:
                        ...
                        Entity(trailmix::file::FileReader* file);   // Creates a blank Entity, then loads its data from a FileReader.
    ...
    virtual void        save(trailmix::file::FileWriter* file); // Saves this Entity to a save game file.
