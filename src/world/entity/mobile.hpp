...
public:
                        ...
                        Mobile(trailmix::file::FileReader* file);   // Creates a blank Mobile, then loads its data from a FileReader.
    virtual             ~Mobile() = default;    // Virtual destructor, in case Mobile is used by a further derived class in the future.
    virtual void        save(trailmix::file::FileWriter* file) override;    // Saves this Mobile to a save game file.
